    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-3">
          ...
          <button className="px-4 py-2 rounded-xl bg-indigo-500 text-white font-semibold hover:bg-indigo-600 shadow-lg shadow-indigo-500/30 transition-all" onClick={() => alert('Feature coming soon!')}><i className="fa-solid fa-plus mr-2"></i> Submit Feedback</button>
        </div>
      </div>
