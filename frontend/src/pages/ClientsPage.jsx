                ...
                <tr key={client.id} className="hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex gap-2">
                      <Link to={`/clients/edit/${client.id}`} className="w-8 h-8 rounded-lg bg-blue-50 dark:bg-blue-500/10 text-blue-600 dark:text-blue-400 hover:bg-blue-100 dark:hover:bg-blue-500/20 transition-colors flex items-center justify-center">
                        <i className="fa-solid fa-pen-to-square"></i>
                      </Link>
                      <DeleteButton id={client.id} onDelete={handleDeleteSuccess} />
                    </div>
                  </td>
                </tr>
              ))}
