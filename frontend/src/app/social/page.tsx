    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-2xl font-extrabold text-slate-800">Social Media Accounts</h2>
        </div>
        <Link href="/social/add-account"><Button variant="primary"><i className="fa-solid fa-plus"></i> Connect Account</Button></Link>
      </div>
          ...
          <GlassCard key={acc.id} className="overflow-hidden p-0">
            ...
            <div className="p-5 grid grid-cols-3 gap-4">
              <div className="text-center">
                <div className="text-xl font-bold text-slate-800">{acc.posts}</div>
                <div className="text-xs text-slate-500">Posts</div>
              </div>
              <div className="text-center border-x border-slate-100">
                <div className="text-xl font-bold text-slate-800">{acc.engagement}</div>
                <div className="text-xs text-slate-500">Engagement</div>
              </div>
              <div className="text-center">
                <div className="text-sm font-semibold text-slate-600">{acc.last_post}</div>
                <div className="text-xs text-slate-500">Last Post</div>
              </div>
            </div>
            <div className="px-5 pb-4 flex gap-2">
              <button className="flex-1 py-2 text-xs font-semibold text-slate-600 bg-slate-100 rounded-lg hover:bg-slate-200 transition-colors">View Analytics</button>
              <button className="w-9 h-9 bg-red-50 text-red-500 rounded-lg flex items-center justify-center hover:bg-red-100 transition-colors">
