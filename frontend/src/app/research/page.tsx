    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-2xl font-extrabold text-slate-800">Research & Development</h2>
        </div>
        ...
        {folders.map((folder) => (
          <GlassCard key={folder.id} className="hover:shadow-lg transition-all hover:-translate-y-1 cursor-pointer group p-0 overflow-hidden">
            ...
            <div className="p-4 flex items-center justify-between">
              <div>
                <div className="text-sm font-semibold text-slate-700">{folder.files} files</div>
                <div className="text-xs text-slate-400">Updated {new Date(folder.updated).toLocaleDateString()}</div>
              </div>
      ...
      <GlassCard>
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={file.name} className="flex items-center justify-between py-3 border-b border-slate-100 last:border-0 hover:bg-slate-50 -mx-2 px-2 rounded-lg transition-colors">
              ...
              <div className="flex items-center gap-3">
                ...
                <button className="w-8 h-8 bg-blue-50 text-blue-500 rounded-lg flex items-center justify-center hover:bg-blue-100 transition-colors">
