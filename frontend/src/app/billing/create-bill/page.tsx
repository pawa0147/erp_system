    ...
    <div className="space-y-6 max-w-[1000px]">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-4">
          ...
          <h2 className="text-2xl font-extrabold text-slate-800">Create New Bill</h2>
        </div>
        <Link href="/billing/list-bills">
          <Button variant="secondary">
            <i className="fa-solid fa-arrow-left"></i> Back to Bills
          </Button>
        </Link>
      </div>
      ...
      <GlassCard>
        <form className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Input label="Client Name" placeholder="Select or type client name" required />
          ...
          <div className="border-t border-slate-200 pt-6">
            <h3 className="text-lg font-bold text-slate-800 mb-4">Line Items</h3>
