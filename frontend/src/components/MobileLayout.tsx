  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen lg:hidden">
        ...
        <main
          className="flex-1 overflow-y-auto page-animate"
          style={{
            background: "var(--glass-panel-bg)",
            backdropFilter: "var(--glass-blur)",
            WebkitBackdropFilter: "var(--glass-blur)",
      ...
      ══════════════════════════════════════════ */}
      <div className="hidden lg:flex gap-3 p-3 min-h-screen">

        {/* Sidebar box */}
        <aside
          className="shrink-0 w-[268px] sticky top-3 self-start"
        ...
        {/* Main content box */}
        <div
          className="flex-1 min-w-0 sticky top-3 self-start"
          style={{ height: "calc(100vh - 24px)" }}
        >
          <div
          ...
          >
            <TopBar onMenuClick={() => {}} />
            <main
              className="page-animate flex-1 overflow-y-auto"
