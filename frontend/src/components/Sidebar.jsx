...
export default function Sidebar({ onClose }) {
  ...
  return (
    <aside className="w-full h-full flex flex-col overflow-hidden">
      ...
      >
        {showDropdown && (
          <div className="absolute bottom-[60px] left-2.5 right-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/10 rounded-xl shadow-lg p-1 z-50">
            <Link onClick={() => { setShowDropdown(false); handleNavClick(); }} to="/settings" className="flex items-center px-3 py-2 text-[12px] font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5 rounded-[9px] transition-colors no-underline">
        ...
        <button
          ...
          className="flex items-center w-full gap-2.5 p-2.5 rounded-[11px] text-left hover:opacity-80 transition-opacity"
          style={{
